...
export function ActionSection(): ReactElement | null {
	...
	}, [address, configuration.tokenToSend?.address, configuration.tokenToSend?.decimals, totalToDisperse]);
	...
	return (
		<div className={'mb-40 mt-20 grid w-full grid-cols-3 gap-7 rounded-3xl bg-accent md:px-16 md:py-[60px]'}>
			<div className={'flex flex-col items-start justify-start gap-2'}>
				...
				<span className={'text-[32px] font-medium leading-[32px]'}>
					{getTotalToDisperse()}
				</span>
			</div>
			...
			<div className={'flex '}>
				<button
					...
					className={
						cl('col-span-1 w-full items-center rounded-3xl bg-secondary text-center text-base text-primary',
